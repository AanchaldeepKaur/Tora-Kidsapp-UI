...
class monthlyprice extends StatefulWidget {
  const monthlyprice({super.key});

  @override
  State<monthlyprice> createState() => _monthlypriceState();
}

class _monthlypriceState extends State<monthlyprice> {
  @override
          ...
          Padding(
            ...
            child: Column(children: [
              Padding(
                ...
                child: Text("Monthly",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 18,color: Colors.white),),
              ),
              ...
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text("\$3",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
                  ),
                  ListTile(
